...
// แสดงปุ่มทดสอบเฉพาะเมื่อเปิดด้วย ?test=true ในบราวเซอร์ (จอใน OBS จะไม่ติดปุ่มนี้ไป)
if (urlParams.get('test') === 'true' || urlParams.get('test') === '1') {
    const testControls = document.getElementById('testControls');
    if (testControls) {
        testControls.classList.add('show-test');
    }
}
